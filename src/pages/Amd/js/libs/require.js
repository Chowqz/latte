...
!(function (global, setTimeout) {
  ...
  let isWebWorker = !isBrowser && 'undefined' != typeof importScripts
  let readyRegExp =
    isBrowser && 'PLAYSTATION 3' === navigator.platform
      ? /^complete$/
      : /^(complete|loaded)$/
  let defContextName = '_'
  let isOpera =
    'undefined' != typeof opera && '[object Opera]' === opera.toString()
  let contexts = {}
  let cfg = {}
  let globalDefQueue = []
  let useInteractive = !1
  ...
  function newContext(u) {
    ...
    function R() {
      let e
      let r
      let t = 1e3 * g.waitSeconds
      let n = t && l.startTime + t < new Date().getTime()
      let o = []
      let a = []
      let s = !1
      let u = !0
    ...
    return (
          ...
          this.depMaps.push(e),
            M(
              ...
              bind(this, function (e) {
                ...
                let t
                let i
                let r = getOwn(v, this.map.id)
                let n = this.map.name
                let a = this.map.parentMap ? this.map.parentMap.name : null
                let s = l.makeRequire(u.parentMap, { enableBuildCallback: !0 })
      ...
      ((l = {
        ...
        configure: function (e) {
          ...
          let r = g.shim
          let n = { paths: !0, bundles: !0, config: !0, map: !0 }
          eachProp(e, function (e, t) {
